...
def main() -> None:
    ...
    ap.add_argument("--encoder-learning-rate", type=float, default=0.0)
    ap.add_argument("--head-learning-rate", type=float, default=0.0)
    ap.add_argument("--positive-class-weight", type=float, default=1.0)
