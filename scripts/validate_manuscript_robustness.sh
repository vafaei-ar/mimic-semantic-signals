...
.venv/bin/python -m py_compile src/89_run_zigong_diffusiongemma_inference.py

.venv/bin/python -m py_compile src/90_evaluate_zigong_diffusiongemma_transport.py
