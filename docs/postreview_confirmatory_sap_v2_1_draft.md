...
The bootstrap count will be **{{REFIT_BOOTSTRAP_REPLICATES}}**, fixed from the synthetic runtime benchmark before registration. The refit distribution supplies the only primary uncertainty interval. The one-sided centered-bootstrap p-value is
