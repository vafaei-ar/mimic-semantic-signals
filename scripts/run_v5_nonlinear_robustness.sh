...
.venv/bin/python src/44_evaluate_nonlinear_structured_robustness.py \
  ...
  --output outputs/vasopressor_incremental_v5_complete_matched/robustness/nonlinear_structured_report.json \
  --folds 5 \
  --repeats 10 \
