...
def main() -> None:
    ap = argparse.ArgumentParser(description="Build enhanced structured baseline features for corrected v2 landmark cohorts.")
    ...
    for outcome in OUTCOMES:
        ...
        keep.to_csv(outdir / "enhanced_structured_features_v2_local.csv", index=False)
        ...
        outcome_reports[outcome] = {
            ...
            "rows_with_all_numeric_features_missing": int(keep[numeric_cols].isna().all(axis=1).sum()),
    ...
    report = {
        "analysis": "Enhanced structured baseline feature extraction v2",
